...
/* 
    Using the create: [] key lets us see typescript types, insuring type safety for our seed data. 
    - installing @types/bcryptjs was necessary to get the associated types for bcryptjs' library. 
